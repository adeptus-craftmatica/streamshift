...
def create_application(argv: Sequence[str] | None = None) -> tuple[QApplication, AppContext, MainWindow]:
    ...
    app.setApplicationName("Stream Controller")
    app.setApplicationDisplayName("Stream Controller")
...
def main(argv: Sequence[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Launch the Stream Controller desktop application.")
    parser.add_argument(
        "--smoke-test",
        action="store_true",
