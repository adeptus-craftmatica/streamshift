...
from PySide6.QtWidgets import (
    QComboBox, QCompleter, QFrame, QGridLayout, QHBoxLayout, QLabel, QLineEdit,
...
class InfoPage(QWidget):
    ...
    def _build_control_tab(self) -> QWidget:
        ...
        self._cat_clear_btn.clicked.connect(lambda: (
            self._cat_input.clear(),
            setattr(self, '_pending_cat_id', ""),
        ))
    ...
    def _on_category_selected(self, name: str) -> None:
        self._pending_cat_id = self._cat_map.get(name, "")
