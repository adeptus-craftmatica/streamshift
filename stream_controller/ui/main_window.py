...
class MainWindow(QMainWindow):
    def __init__(self, app_context: AppContext) -> None:
        ...
        self.setWindowTitle("StreamShift")
    ...
    def _build_header(self) -> QFrame:
        ...
        setup_btn.setObjectName("HelpButton")
        setup_btn.setFixedHeight(28)
        setup_btn.setToolTip("Re-run the first-time setup wizard")
        ...
        badges_row.addWidget(setup_btn)
    ...
    def _open_setup_wizard(self) -> None:
        from stream_controller.ui.setup_wizard import SetupWizard, reset_setup
        reset_setup()
